...
(function () {
  ...
  const CHARACTER_CATALOG = [
    { id: 'char_agent_mike', name: 'Agent Mike', file: 'agent_mike.png', frameWidth: 32, frameHeight: 32, frames: 2, opaqueTop: 17, opaqueCenter: 19, hatScale: 0.88, hatFlip: true, hatOffsetX: -2 },
    { id: 'char_angie', name: 'Angie', file: 'angie.png', frameWidth: 32, frameHeight: 32, frames: 6, opaqueTop: 13, opaqueCenter: 15.5, hatScale: 0.72, hatFlip: true, hatOffsetY: 4.25 },
    { id: 'char_armand', name: 'Armand', file: 'armand.png', frameWidth: 32, frameHeight: 32, frames: 5, opaqueTop: 1, opaqueCenter: 15, hatScale: 1.25, hatFlip: true, hatOffsetX: 1.5 },
    ...
    { id: 'char_barry_cherry', name: 'Barry Cherry', file: 'barry_cherry.png', frameWidth: 32, frameHeight: 32, frames: 4, opaqueTop: 12, opaqueCenter: 16, hatScale: 0.82, hatFlip: true, hatOffsetY: 5.25 },
    { id: 'char_big_red', name: 'Big Red', file: 'big_red.png', frameWidth: 32, frameHeight: 32, frames: 6, opaqueTop: 12, opaqueCenter: 15, hatScale: 1.06, hatFlip: true, hatOffsetX: 1, hatOffsetY: 1 },
    { id: 'char_blankey', name: 'Blankey', file: 'blankey.png', frameWidth: 32, frameHeight: 32, frames: 4, opaqueTop: 9, opaqueCenter: 15.5, hatScale: 1, hatFlip: true, hatOffsetX: 1 },
    ...
    { id: 'char_bumpy_the_robot', name: 'Bumpy the Robot', file: 'bumpy_the_robot.png', frameWidth: 16, frameHeight: 16, frames: 4, opaqueTop: 3, opaqueCenter: 7.5, hatScale: 0.78, hatFlip: true, hatOffsetY: -0.25 },
    { id: 'char_bushly', name: 'Bushly', file: 'bushly.png', frameWidth: 16, frameHeight: 16, frames: 3, opaqueTop: 3, opaqueCenter: 7.5, hatScale: 0.68, hatFlip: true },
    ...
    { id: 'char_devo_the_devil', name: 'Devo the Devil', file: 'devo_the_devil.png', frameWidth: 16, frameHeight: 16, frames: 1, opaqueTop: 2, opaqueCenter: 7.5, hatScale: 0.89, hatOffsetY: 0.85 },
    { id: 'char_diver_the_fish', name: 'Diver the Fish', file: 'diver_the_fish.png', frameWidth: 16, frameHeight: 16, frames: 4, opaqueTop: 1, opaqueCenter: 7, hatScale: 0.83, hatOffsetY: 0.85 },
    { id: 'char_fairy', name: 'Fairy', file: 'fairy.png', frameWidth: 32, frameHeight: 32, frames: 4, opaqueTop: 5, opaqueCenter: 15.5, hatScale: 0.52, hatFlip: true, hatOffsetX: 1, hatOffsetY: 1 },
    { id: 'char_geralt', name: 'Geralt', file: 'geralt.png', frameWidth: 32, frameHeight: 32, frames: 2, opaqueTop: 14, opaqueCenter: 16, hatScale: 0.55, hatFlip: true },
    ...
    { id: 'char_grizzly', name: 'Grizzly', file: 'grizzly.png', frameWidth: 48, frameHeight: 32, frames: 1, opaqueTop: 8, opaqueCenter: 15, hatScale: 0.95, hatOffsetY: 2.1 },
    { id: 'char_gum_bot', name: 'Gum Bot', file: 'gum_bot.png', frameWidth: 32, frameHeight: 32, frames: 4, opaqueTop: 14, opaqueCenter: 15.5, hatScale: 0.89, hatFlip: true },
    { id: 'char_hermie', name: 'Hermie', file: 'hermie.png', frameWidth: 32, frameHeight: 32, frames: 2, opaqueTop: 18, opaqueCenter: 22, hatScale: 0.75, hatFlip: true, hatOffsetX: 1, hatOffsetY: 1 },
    { id: 'char_jumpy_lumpy', name: 'Jumpy Lumpy', file: 'jumpy_lumpy.png', frameWidth: 32, frameHeight: 32, frames: 2, opaqueTop: 21, opaqueCenter: 15.5, hatScale: 0.78, hatFlip: true },
    { id: 'char_lil_wiz', name: 'Lil Wiz', file: 'lil_wiz.png', frameWidth: 32, frameHeight: 32, frames: 5, opaqueTop: 6, opaqueCenter: 15.5, hatScale: 1.11, hatFlip: true, hatOffsetY: 4.25 },
    { id: 'char_martian_red', name: 'Martian Red', file: 'martian_red.png', frameWidth: 32, frameHeight: 32, frames: 2, opaqueTop: 11, opaqueCenter: 15.5, hatScale: 0.72, hatFlip: true, hatOffsetY: 4.25 },
    { id: 'char_moe_scotty', name: 'Moe Scotty', file: 'moe_scotty.png', frameWidth: 32, frameHeight: 32, frames: 4, opaqueTop: 4, opaqueCenter: 16, hatScale: 1.25, hatOffsetY: 1.3 },
    { id: 'char_mr_chomps', name: 'Mr. Chomps', file: 'mr_chomps.png', frameWidth: 32, frameHeight: 32, frames: 12, opaqueTop: 17, opaqueCenter: 8, hatScale: 0.95, hatOffsetX: 2.1 },
    { id: 'char_mr_circuit', name: 'Mr. Circuit', file: 'mr_circuit.png', frameWidth: 32, frameHeight: 32, frames: 2, opaqueTop: 9, opaqueCenter: 15, hatScale: 0.65, hatFlip: true, hatOffsetY: 2.1 },
    { id: 'char_mr_man', name: 'Mr. Man', file: 'mr_man.png', frameWidth: 16, frameHeight: 16, frames: 4, opaqueTop: 1, opaqueCenter: 7.5, hatScale: 1.24, hatFlip: true, hatOffsetX: 0.85 },
    { id: 'char_mr_mochi', name: 'Mr. Mochi', file: 'mr_mochi.png', frameWidth: 32, frameHeight: 32, frames: 2, opaqueTop: 14, opaqueCenter: 15.5, hatScale: 0.88, hatFlip: true, hatOffsetY: 0.85 },
    { id: 'char_octi', name: 'Octi', file: 'octi.png', frameWidth: 16, frameHeight: 16, frames: 2, opaqueTop: 4, opaqueCenter: 7.5, hatScale: 0.78 },
    { id: 'char_onion_lad', name: 'Onion Lad', file: 'onion_lad.png', frameWidth: 16, frameHeight: 16, frames: 2, opaqueTop: 3, opaqueCenter: 7.5, hatScale: 0.68, hatFlip: true },
    { id: 'char_orange', name: 'Orange', file: 'orange.png', frameWidth: 32, frameHeight: 32, frames: 4, opaqueTop: 10, opaqueCenter: 13.5, hatScale: 0.82, hatFlip: true, hatOffsetY: 3.4 },
    { id: 'char_orc', name: 'Orc', file: 'orc.png', frameWidth: 64, frameHeight: 32, frames: 7, opaqueTop: 6, opaqueCenter: 28, hatScale: 1, hatOffsetX: 1.7 },
    { id: 'char_orchid_owl', name: 'Orchid Owl', file: 'orchid_owl.png', frameWidth: 32, frameHeight: 32, frames: 2, opaqueTop: 12, opaqueCenter: 15.5, hatScale: 0.7, hatFlip: true, hatOffsetY: 3 },
    { id: 'char_penguin', name: 'Penguin', file: 'penguin.png', frameWidth: 16, frameHeight: 16, frames: 5, opaqueTop: 2, opaqueCenter: 7.5, hatScale: 1.3, hatFlip: true },
    { id: 'char_percy', name: 'Percy', file: 'percy.png', frameWidth: 32, frameHeight: 32, frames: 9, opaqueTop: 8, opaqueCenter: 15, hatScale: 0.9, hatFlip: true, hatOffsetX: 1, hatOffsetY: 1 },
    ...
    { id: 'char_roach', name: 'Roach', file: 'roach.png', frameWidth: 32, frameHeight: 32, frames: 2, opaqueTop: 13, opaqueCenter: 16, hatScale: 0.65, hatFlip: true, hatOffsetX: 3, hatOffsetY: 3 },
    { id: 'char_robo_pumpkin', name: 'Robo Pumpkin', file: 'robo_pumpkin.png', frameWidth: 16, frameHeight: 16, frames: 1, opaqueTop: 2, opaqueCenter: 7.5, hatScale: 0.65 },
    { id: 'char_robo_retro', name: 'Robo Retro', file: 'robo_retro.png', frameWidth: 32, frameHeight: 32, frames: 9, opaqueTop: 10, opaqueCenter: 15.5, hatScale: 0.9, hatFlip: true },
    ...
    { id: 'char_robot_j5', name: 'Robot J5', file: 'robot_j5.png', frameWidth: 32, frameHeight: 32, frames: 5, opaqueTop: 16, opaqueCenter: 15.5, hatScale: 1, hatFlip: true },
    { id: 'char_robot_walky', name: 'Robot Walky', file: 'robot_walky.png', frameWidth: 32, frameHeight: 32, frames: 2, opaqueTop: 14, opaqueCenter: 15.5, hatScale: 0.72 },
    { id: 'char_rocket_cherry', name: 'Rocket Cherry', file: 'rocket_cherry.png', frameWidth: 16, frameHeight: 32, frames: 2, opaqueTop: 14, opaqueCenter: 8.5, hatScale: 0.62, hatFlip: true },
    { id: 'char_rolling_nero', name: 'Rolling Nero', file: 'rolling_nero.png', frameWidth: 16, frameHeight: 16, frames: 6, opaqueTop: 3, opaqueCenter: 7.5, hatScale: 0.68 },
    { id: 'char_skeleton', name: 'Skeleton', file: 'skeleton.png', frameWidth: 32, frameHeight: 32, frames: 9, opaqueTop: 3, opaqueCenter: 16, hatScale: 0.65, hatFlip: true },
    ...
    { id: 'char_spikey_bub', name: 'Spikey Bub', file: 'spikey_bub.png', frameWidth: 16, frameHeight: 16, frames: 2, opaqueTop: 4, opaqueCenter: 7.5, hatScale: 0.6 },
    { id: 'char_squirmy_wormy', name: 'Squirmy Wormy', file: 'squirmy_wormy.png', frameWidth: 32, frameHeight: 32, frames: 3, opaqueTop: 18, opaqueCenter: 15, hatScale: 0.7 },
    ...
    { id: 'char_twiggy', name: 'Twiggy', file: 'twiggy.png', frameWidth: 32, frameHeight: 32, frames: 5, opaqueTop: 6, opaqueCenter: 15, hatScale: 0.7, hatFlip: true },
    { id: 'char_vessa', name: 'Vessa', file: 'vessa.png', frameWidth: 32, frameHeight: 32, frames: 10, opaqueTop: 5, opaqueCenter: 15, hatScale: 0.65, hatFlip: true },
    { id: 'char_wispy_fire', name: 'Wispy Fire', file: 'wispy_fire.png', frameWidth: 32, frameHeight: 32, frames: 21, opaqueTop: 13, opaqueCenter: 15.5, hatScale: 0.65 },
  ];
